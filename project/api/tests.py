...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """
        Testing for questions with future pub_date
        """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_two_past_questions(self):
        ...
        """
        create_question(q_text="Past question 1.", days=-30)
        create_question(q_text="Past question 2.", days=-5)
        response = self.client.get(reverse('api:index'))
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        ...
        """
        future_question = create_question(q_text="Future question", days=5)
        url = reverse("api:detail", args=(future_question.id,))
    ...
    def test_past_question(self):
        ...
        url = reverse('api:detail', args=(past_question.id,))
        response = self.client(url)
